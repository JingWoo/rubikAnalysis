...
- 🎯 Entry points to execute your program using `python -m <rubikanalysis>` or `$ rubikanalysis` with basic CLI argument parsing.
...
Awesome rubikanalysis created by JingWoo

## Install it from PyPI

```bash
pip install rubikanalysis
```

## Usage

```py
from rubikanalysis import BaseClass
from rubikanalysis import base_function
